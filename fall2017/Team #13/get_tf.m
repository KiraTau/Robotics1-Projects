...
images = imageDatastore(fullfile('C:/Users/Tao/OneDrive/School/Robotics/project/tfcali'));
for i = 1:2
    ...
    string=[chr,'.jpg'];
    imwrite(Ji,string);
    movefile(string,'C:/Users/Tao/OneDrive/School/Robotics/project/undistorted/transcali');
    figure(); imshowpair(Ki,Ji,'montage');
    title('Full Image (left) vs. Corrected Image (right)');
end
Dir = fullfile('C:/Users/Tao/OneDrive/School/Robotics/project/undistorted/transcali')
pictures = imageDatastore(Dir);

% Display images to be stitched
montage(pictures.Files)
